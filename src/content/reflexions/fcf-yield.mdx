Le <Terme id="per-valorisation" label="PER" /> et l'EV/EBITDA ont leurs limites. Le PER est sensible aux choix comptables sur les amortissements et les charges exceptionnelles. L'EV/EBITDA exclut les impôts et les investissements de maintien. Les deux peuvent donner une image flatteuse d'une entreprise qui ne génère en réalité que peu de cash.
