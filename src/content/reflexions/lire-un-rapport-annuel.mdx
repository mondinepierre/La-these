...
**Le [chiffre d'affaires](/glossaire/chiffre-affaires) par segment.** Pas le total consolidé, les segments. La croissance globale peut cacher un segment porteur et un autre en déclin. C'est dans le MD&A ou dans les notes segmentées.
...
**Le [free cash flow](/glossaire/free-cash-flow).** Ligne "Net cash provided by operating activities" moins "Capital expenditures" dans le tableau des flux. Vous comparez à l'EBITDA ou au [résultat net](/glossaire/marge-nette) : si l'écart est persistant et important, il faut creuser pourquoi.

**La dette nette.** Total de la dette financière moins la trésorerie. Vous divisez par l'[EBITDA](/glossaire/ebitda) pour obtenir le ratio [Dette/EBITDA](/glossaire/dette-ebitda). Au-dessus de 3x dans un secteur non financier, ça mérite attention. Au-dessus de 4x, c'est une contrainte structurelle sur l'allocation de capital.

**Le [Capex](/glossaire/capex).** À décomposer si possible entre maintenance et croissance. Les entreprises ne publient pas toujours cette distinction, mais le MD&A l'explique souvent qualitativement. Un Capex qui croît plus vite que les revenus peut signifier soit un investissement dans la croissance future (bon signe si le [ROIIC](/glossaire/roiic) tient), soit une fuite en avant sur l'outil industriel (mauvais signe).
