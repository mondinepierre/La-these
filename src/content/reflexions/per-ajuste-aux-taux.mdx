...
Le <Terme id="per-valorisation" label="PER" /> est l'indicateur de valorisation le plus utilisé. Il est aussi l'un des plus mal interprétés, parce qu'on le compare souvent à des références historiques sans ajuster pour les taux d'intérêt.
