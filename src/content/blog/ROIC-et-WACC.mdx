...
<div className="my-4 py-2 border-y border-stone-border"><span className="block text-center text-lg font-display italic text-accent tracking-tight">Résultat opérationnel * (1 - taux d'imposition)</span></div>
