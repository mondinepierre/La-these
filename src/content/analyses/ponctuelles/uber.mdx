...
Le ROCE épouse le ROIC : la dette nette d'Uber étant positive, le capital employé et le capital investi coïncident, et les deux mesures convergent. La conclusion est identique, le rendement du capital a franchi son coût en 2025.

### Rentabilité des investissements incrémentaux

<MetricGraph_ROIIC_YoY title="ROIIC annuel (%)" />

Le ROIIC annuel est peu exploitable sur la période : la sortie des pertes fait varier brutalement le NOPAT et les capitaux propres (entamés par la perte de 2022), ce qui produit des ratios erratiques. C'est un artefact de la bascule de rentabilité, pas un signal de qualité d'allocation, d'où la lecture lissée ci-dessous.

<MetricGraph_ROIIC title="ROIIC glissant (1 à 3 ans, %)" />

Lissé sur plusieurs années, le rendement des capitaux investis ressort franchement positif (environ 30 % sur 1 et 2 ans, davantage encore sur 3 ans). Uber a ajouté un NOPAT considérable sur une base de capital quasi stable : c'est la signature du levier opérationnel d'un modèle asset-light.
