...
<MetricGraph_EV_EBITDA title="EV / EBITDA (x)" />

Le multiple d'[EV/EBITDA](/glossaire/ev-ebitda) est ici calculé sur l'EBITDA GAAP (résultat opérationnel plus amortissements, 6,3 Md$ en 2025), à distinguer de l'EBITDA ajusté publié par Uber (8,7 Md$, qui réintègre notamment la rémunération en actions). Il ressort à 28x en 2025 et se compresse vite (70x en 2023, quand l'EBITDA GAAP était encore modeste) à mesure que les profits montent. Le radar comparatif ci-dessus est, lui, en base marché (EBITDA ajusté, environ 21x) : l'écart tient à la base d'EBITDA retenue.
