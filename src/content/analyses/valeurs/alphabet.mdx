...
# <span className="text-gold">361 – 401 $</span>

<span className="text-sm text-ink-muted">*Scénario central : BPA projeté FY2028 = 17,67 $ (CAGR 17,8 % × 3 ans) × PER central 20,41x = 360,7 $. Scénario optimiste : BPA FY2028 = 19,63 $ (CAGR 22 % × 3 ans) × PER 20,41x = 400,7 $. Marge d'erreur ±16,8 % (Beta 1,118 × 15 %).*</span>
