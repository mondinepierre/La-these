...
La croissance d'Alphabet et les attentes des investisseurs ont fait monter le [PER](/glossaire/per-valorisation) jusqu'à 30 en fin d'année 2025 avant de redescendre fin mars (26.91x au 25 mars 2026)
<MetricGraph_PER title="PER sur 5 ans" />
Avec un **[PER](/glossaire/per-valorisation) historique de 24.3**, je pense que l'action, est à date, **légèrement surévaluée**. La valorisation actuelle semble refléter les attentes du marché.

Le groupe, par rapport à 2 concurrents directs mais sur des domaines bien différents (Meta pour l'advertising, et Microsoft pour le Cloud et l'IA) possède des chiffres moins attractifs sur le [P/FCF](/glossaire/p-fcf) et l'[EV/EBITDA](/glossaire/ev-ebitda) impactés directement par les **[Capex](/glossaire/capex) massifs**.  
...
Malgré tout cela, Alphabet génère un **[ROIC](/glossaire/roic) supérieur à la concurrence**, signe d'une vraie capacité de conversion de la valeur.

Si on regarde la trésorerie et les flux, le [FCF Yield](/glossaire/fcf-yield) se comprime de plus de 3,5 points depuis 2022 et passe **sous le taux sans risque américain en 2025**.  
...
Quand on connait la formule du [ROIC](/glossaire/roic) (NOPAT / Capitaux investis) on comprend que le ROIC s'effrite à mesure que le cloud progresse.  
...
Un autre élément de réponse se trouve dans l'effet de [levier opérationnel](/glossaire/levier-operationnel). 
...
Depuis la récente mise en place des dividendes, le [payout ratio](/glossaire/payout-ratio) s'établit aux alentours de 7.5% et est en croissance.
...
Le groupe possède en moyenne 2 fois plus d'actifs court terme que de dette à rembourser sur l'année. ([Current Ratio](/glossaire/current-ratio))

<MetricGraph_DSO title="DSO sur 5 ans" />
Cela s'explique en partie par son [DSO](/glossaire/dso) (Days Sales Outstanding, ou délai moyen de paiement en français) qui est amélioré par la partie **B2C**.  
...
Son statut de leader autour du monde, lui assure une diversification géographique que peu d'entreprises peuvent se vanter d'avoir.
...
- **Efficience du capital (ROIC) :** Capacité prouvée à générer un Retour sur Capitaux Investis ([ROIC](/glossaire/roic) > 24 %) supérieur à la moyenne du secteur, validant une création de valeur réelle.
- **Forteresse financière :** Trésorerie nette massive ([Dette Nette / EBITDA](/glossaire/dette-ebitda) de -0.53x) permettant de financer simultanément des Capex historiques (91 Mds $), des rachats d'actions et un dividende.
...
- **Dépendance aux TAC (Traffic Acquisition Costs) :** Le [moat](/glossaire/moat) repose en partie sur les dizaines de milliards payés annuellement à Apple pour maintenir Google comme moteur par défaut sur iOS.
...
Si l'IA continue sa croissance exceptionnelle, Alphabet fera partie des premiers servis.
