...
- **45,4 % Exploration - Production**
  - 17 Mds $ de [marge brute d'autofinancement](/glossaire/marge-brute-d-autofinancement) en 2024.
  - 9 Mds $ d'investissements organiques.
- **22,3 % [GNL](/glossaire/gnl)**
  - 1er exportateur de GNL aux US.
  - 4,9 Mds $ de marge brute d'autofinancement en 2024.
- **11,9 % [Integrated Power](/glossaire/integrated-power)**
...
**Ce qui n'est pas un [moat](/glossaire/moat).** Les contrats d'approvisionnement énergétique avec Google et Microsoft sont des signaux positifs sur la demande en électricité renouvelable, pas des avantages concurrentiels. Ce sont des clients, pas des fossés défensifs — une confusion fréquente.
...
Sur les **27,3 Mds $ de cash flow d'exploitation**, TotalEnergies réinvestit **16,9 Mds $ en [CAPEX](/glossaire/capex) (62 %)** et retourne **58 % aux actionnaires** (8,1 Mds $ de dividendes + 7,7 Mds $ de rachat d'actions).

TotalEnergies peut se permettre de dépenser plus que son cash flow d'exploitation car ses investissements massifs en CAPEX sont fructueux — le [ROIC](/glossaire/roic) reste supérieur au [WACC](/glossaire/wacc) malgré la compression liée au cycle pétrolier.
...
La section aurait pu s'intituler **"Pourquoi maintenant"**, mais il faut désormais attendre de voir l'évolution du conflit en Iran pour revenir à des [multiples de valorisation](/glossaire/multiple-de-valorisation) correspondant à la moyenne PER historique de 8,8×.

<MetricGraph_PER title="Évolution du PER — TotalEnergies vs Shell et Equinor" />

### Horizon

Entreprise fond de portefeuille, le but étant de croître grâce aux dividendes réinvestis pour bénéficier de l'effet des [intérêts composés](/glossaire/interet-compose).
...
La plus grosse incidence est l'impact sur le [free cash flow](/glossaire/free-cash-flow) de l'entreprise, qui reste malgré tout **largement excédentaire**.
...
### Dette nette / [EBITDA](/glossaire/ebitda) : 0,59×
...
### [Current ratio](/glossaire/current-ratio) : 0,97 et [DSO](/glossaire/dso) : 33 jours
...
- **Enjeux climatiques.** Avec les engagements pris dans les COP28 et COP29, TotalEnergies devra réussir sa métamorphose au rythme imposé. Le risque de [stranded assets](/glossaire/stranded-assets) (actifs fossiles dépréciés avant amortissement) et de taxation carbone progressive sur le [scope 3](/glossaire/scope-3) n'est pas couvert par l'objectif neutralité 2050 de TTE.
...
**[Marge de sécurité](/glossaire/marge-de-securite) actuelle :** négative (−47 % à −77 %) — attendre un repli significatif avant de réengager.
