...
const REGION_TO_CODES: Record<string, string[]> = {
  ...
  'Marchés émergents': [
    ...
    '894',    '012', '024', '072', '108', '120', '132', '140', '148', '174', '178', '180', '204',
    '226', '231', '232', '262', '266', '270', '288', '324', '384', '404', '426', '430',
    '434', '450', '454', '466', '478', '480', '504', '508', '516', '562', '566', '624',
    '646', '678', '686', '694', '706', '710', '716', '728', '729', '748', '768', '788',
    '800', '818', '834', '854', '894',    '048', '275', '364', '368', '376', '400', '414', '422', '512', '634', '682', '760',
    '784', '792', '887', '028', '032', '044', '052', '068', '076', '084', '136', '152', '170', '188', '192',
    '212', '214', '218', '222', '308', '320', '328', '332', '340', '388', '474', '558',
    '591', '600', '604', '659', '662', '670', '740', '780', '858', '862', '643'
  ],
  ...
  'EMEA': [
    ...
    '008', '020', '040', '056', '070', '100', '112', '191', '196', '203', '208', '233',
    '246', '250', '276', '300', '348', '352', '372', '380', '428', '438', '440', '442',
    '470', '492', '498', '499', '528', '578', '616', '620', '642', '643', '674', '688', 
    '703', '705', '724', '752', '756', '804', '807', '826',
    // Moyen-Orient
    '048', '275', '364', '368', '376', '400', '414', '422', '512', '634', '682', '760',
    '784', '792', '887',
  ...
  // Canada + Amérique Latine (hors États-Unis)
  'Other Americas': [
    '124',
    '028', '032', '044', '052', '068', '076', '084', '136', '152', '170', '188', '192',
    '212', '214', '218', '222', '308', '320', '328', '332', '340', '388', '474', '484',
    '558', '591', '600', '604', '659', '662', '670', '740', '780', '858', '862',
  ],
  ...
  'Asie du Nord': [
    '156', // Chine
    '158', // Taïwan
    '344', // Hong Kong (ajouté pour exhaustivité L'Oréal)
    '392', // Japon
    '408', // Corée du Nord
    '410', // Corée du Sud
    '446', // Macao (ajouté pour exhaustivité L'Oréal)
    '496', // Mongolie
  ],

  'SAPMENA - SSA': [
    // Fusion du reste de l'Asie, de l'Océanie, du Moyen-Orient et de l'Afrique.
    '004', '012', '024', '031', '036', '048', '050', '051', '064', '072', '090', '096',
    '104', '108', '116', '120', '132', '140', '144', '148', '174', '178', '180', '204',
    '226', '231', '232', '242', '262', '266', '268', '270', '275', '288', '296', '324',
    '356', '360', '364', '368', '376', '384', '398', '400', '404', '414', '417', '418',
    '422', '426', '430', '434', '450', '454', '458', '462', '466', '478', '480', '504',
    '508', '512', '516', '520', '524', '540', '548', '554', '562', '566', '583', '584',
    '585', '586', '598', '608', '624', '626', '634', '646', '678', '682', '686', '694',
    '702', '704', '706', '710', '716', '728', '729', '748', '760', '762', '764', '768',
    '776', '784', '788', '792', '795', '798', '800', '818', '834', '854', '860', '882',
    '887', '894',
  ],
